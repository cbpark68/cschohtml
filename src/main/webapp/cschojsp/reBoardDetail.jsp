...
String sql = "select title,name,rdate,content from reboard where unq = "+unq;
		...
		<section>
			<article>
				...
				<div style="width:600px;text-align:center;margin-top:10px;">
					...
					<button type="button" onclick="location='boardPassWrite.jsp?unq=<%=unq%>&gubun=R';">삭제</button>	
				</div>
			</article>
		</section>
